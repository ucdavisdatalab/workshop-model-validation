...
for ( i in 1:nfold ) {
  ...
  pred_covid[ fold == i ] = predict(boost, covid, type='response')[ fold == i ]
}

plot(pred_covid, covid$D1_admissions, xlab="prediction", ylab="actual future admissions")
abline(a=0, b=1)
```
