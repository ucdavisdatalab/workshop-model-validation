...
- Observations are usualy assumed to be independent of each other (or assume some specific form of dependence).
...
# How to begin?
Validation begins when you first look at your data. This is when you can begin to ask questions like,
...
If you have answers to these, then you are well on your way to creating a great model.

## Examples
Let's load the data for a few examples of the data we'll be looking at today.
...
with( gbsg, plot( list(sqrt(er), sqrt(pgr), sqrt(nodes), rfstime)))
```
